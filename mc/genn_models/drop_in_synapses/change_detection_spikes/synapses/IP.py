from genn_models.event_utils import (WU_TRANSMIT, WU_VAR_SPACE_TRANSMIT,
                                     WU_PARAM_SPACE_TRANSMIT, PS_TRANSMIT,
                                     PS_VAR_SPACE_TRANSMIT, PS_PARAM_SPACE_TRANSMIT,
                                     generate_event_plast_wu_dict,
...
w_update_model_plast = generate_event_plast_wu_dict("weight_update_model_pyr_to_int", f)
