...
f = "$(err_fb_post) * $(dr_min_2_post) * $(r_trace_min_2_pre) - $(w_penalty) * $(g)"

wu_param_space_plast = dict(WU_PARAM_SPACE_PLAST[mod_type])
wu_param_space_plast["w_penalty"] = 1e-3
w_update_model_plast = generate_plast_wu_dict(mod_type, "weight_update_model_hidden_in", f,
