from models.event_utils import (WU_TRANSMIT, WU_VAR_SPACE_TRANSMIT, WU_PARAM_SPACE_TRANSMIT,
...
w_update_model_plast = generate_event_plast_wu_dict("weight_update_model_pyr_to_pyr_back", f)
